...
# Test Functions
separate_bike_models(bike_data_tbl)

# Save Functions
function_names <- c("separate_bike_models")
dump(function_names, file = "scripts/funcs_separate_bike_models.R")
